...
class PictureGeotagedFailed(BaseMsg):
    TOPIC = "picture_geotagged_failed"
    def __init__(self):
        self.message_type = "picture_geotagged_failed"
        self.file_path = ""
        self.altitude = ""
...
def MsgHandeler(msg):
    MsgList = [TakePicture(), PictureTaken(), PictureGeotaged(), PictureDownloaded(), PictureTimeReferenced(), TriggerAction(), PictureGeotagedFailed()]
    topic = msg.split()[0]
    good_obj = None
